...
const Add = ({ token }) => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col px-4 sm:px-0'>
      <div className='mb-3'>
        ...
        <div className='flex flex-wrap gap-2'>
          <label htmlFor="image1">
            <img
              className='w-20 cursor-pointer rounded border'
        ...
        <div className='flex flex-wrap gap-3'>
          {sizeOptions.map(size => (
            ...
            >
              <p
                className={`${
                  sizes.includes(size) ? "bg-[#FBE4DC]" : "bg-slate-200"
      ...
      <button
        type='submit'
        className='w-full sm:w-28 py-3 mt-4 bg-[#5C4033] text-white active:bg-[#b97111] cursor-pointer rounded'
      >
        Add
      </button>
    </form>
